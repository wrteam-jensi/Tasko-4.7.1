...
const NearbyProviderCard = ({ provider }) => {
  return (
    <div className="w-full rounded-2xl overflow-hidden border border-gray-100 bg-white transition-all duration-300 group flex flex-col h-full hover:shadow-md">
      {/* Cover Image */}
